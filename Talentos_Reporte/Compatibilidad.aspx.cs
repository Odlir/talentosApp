...
using wsCompatibilityReport;
using System.Net;

public partial class Compatibilidad : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Request.QueryString.Count > 0)
            {
                ...
                {
                    redirect("Compatibilidad.aspx", "Error al descargar los datos del id ó token");
                }

                if (jsonInteres.Length > 20)
                {
                    wsCompatibilityReport.wsCompatibilityReport objReport = new wsCompatibilityReport.wsCompatibilityReport();
                    string nombrePDF = "";
                    try
                    {
                    ...
                    {
                        redirect("Compatibilidad.aspx", "Ocurrio un error al obtener el Id y Token.");
                    }
                }
            }
